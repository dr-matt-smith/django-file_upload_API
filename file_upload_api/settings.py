"""
Django settings for file_upload_api project.
...
ROOT_URLCONF = 'file_upload_api.urls'
...
WSGI_APPLICATION = 'file_upload_api.wsgi.application'
...
STATIC_URL = 'static/'
# Required by `collectstatic` (e.g. on PythonAnywhere). Harmless in dev.
